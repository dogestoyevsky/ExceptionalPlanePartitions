...
\section{Computation of period}\label{sec:period} We use Proposition~\ref{prop:deflation_commutation} to relate the period of $T \in \inc^m(\lambda)$ under $\pro^m$ to data concerning $\deflate^m(T)$. Let 
...
&= \pro^{m_T} \circ \deflate^m (T) &\text{Proposition~\ref{prop:deflation_commutation}, $w\lbrace 1 \rbrace = 1$} \\
