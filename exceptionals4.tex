...
In light of Corollary~\ref{cor:multisets}, we now turn to a more thorough studying of increasing tableaux. Let $\lambda$ be an order ideal in a minuscule poset.
...
Using this definition of $K$-promotion from Section~\ref{sec:Kpromotion}, we give names to the intermediate products of $\pro^m$.
