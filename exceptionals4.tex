...
For example, we evaluate $f_{\lambda_p}(\zeta^{m/d})$ for some $d > 1$ dividing both $m$ and $p$. By definition,
...
\[ \mathcal{R}(\lambda_p,m,d) = f_{m,2p-1}(1) + 2 \, f_{m,2p}(1) = \binom{m}{2p-1} + 2 \binom{m}{2p} = \frac{(2m-2p+2)m!}{(2p)!(m-2p+1)!} = f_{\lambda_p}(1). \]
...
If $d$ divides neither $p$ nor $2p-1$, then on the one hand Theorem~\ref{thm:mainresult} predicts that $\mathcal{R}(\lambda_p,m,d) = 0$, and on the other hand $d$ divides $\lceil{\frac{2p}{d}}\rceil$ of the terms in the numerator of $f_{\lambda_p}(\zeta^{m/d})$ and at most $\lfloor{\frac{2p}{d}}\rfloor$ of the terms in the denominator, so $f_{\lambda_p}(\zeta^{m/d}) = 0$. 
\end{proof}
