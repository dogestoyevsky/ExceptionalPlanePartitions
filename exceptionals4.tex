...
\end{equation}
Now say $\tau$ divides $jN_T$. Then \[ \frac{\tau}{\text{gcd}(\frac{\ell N_T}{m},\tau)} \ \ \  \text{    divides   } \ \ \ \frac{j N_T}{\text{gcd}(\frac{\ell N_T}{m},j N_T)}.\] It follows that the period associated to $\tau$ divides $j m$. 
\end{proof}
