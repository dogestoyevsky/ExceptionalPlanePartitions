...
In this subsection, we recall results of \cite{Dilks.Striker.Vorland} (building on \cite{DPS}) that enable us to study the rowmotion action $\Psi$ via the action of $K$-promotion on increasing tableaux.
...
Corollary 5.2. There is an equivariant bijection between Incq (P) under promotion and order ideals in Γ1(P, q) under rowmotion

which I think is exactly what we want, assuming 3.28 means what I think it does.
