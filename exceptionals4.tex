...
The resulting formula is simple enough to check by hand. We will need the fact that the number of elements of $\binom{[i]}{j}$ of any fixed $\Sigma^i$-order is given explicitly by \cite[Theorem~1.1(b)]{Reiner.Stanton.White}:
