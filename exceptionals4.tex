...
Fix $\lambda \in \lbrace \lambda_{F}, \lambda_k, \lambda_{CM} \rbrace$, $M \geq \rank(\lambda)$, and $d$ dividing $q$. Then the number of increasing tableaux of height $q$ whose period under $\pro^q$ divides $q/d$ is 
\[ \sum \limits_{i: \, d \, \vert \, \frac{N_T[i]}{\tau[i]}} \tau[i] \, N[i] \, f_{q,N_T}(\zeta^{q/d}).\]
\end{theorem}
\begin{proof}
