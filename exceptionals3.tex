...
Let $\lambda$ be a justified convex shape. Then $\Omega$ intertwines $\mot_{\mathrm{id},(1,1,-1)}$ and $\pro$. That is, for $P \in J(\lambda \times [m])$, we have $\Omega \circ \mot_{\mathrm{id},(1,1,-1)}(P) = \pro^{\rank(\lambda)+m+1} \circ \Omega(P)$.
\end{proposition}
\begin{proof}
