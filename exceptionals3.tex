...
\end{tikzpicture}
\caption{The tableau $T_3$ is obtained from $T$ by first applying in sequence the operations $\rep_{1 \rightarrow \bullet}$, $\swap_2$, and $\swap_3$, and then restricting to those boxes with labels less than or equal to $3$.}
\end{figure}
