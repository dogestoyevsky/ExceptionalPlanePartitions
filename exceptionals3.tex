...
\begin{figure}[h]
	\begin{subfigure}[b]{0.27\textwidth}
		\centering
		\ydiagram{5,2+3,3+3,3+5}
		\caption{Cayley poset}
	\end{subfigure} \\ \vspace{4mm}
	\begin{subfigure}[b]{0.27\textwidth}
		\centering
		\ydiagram{6,3+3,4+3,4+5,4+5,7+2,8+1,8+1,8+1}
...
\begin{figure}[h]
\begin{tikzpicture}
\node (A) {\ytableaushort{1235,\none 45, \none \none 6} };
\node[above right = 1 and 1 of A] (B) {\ytableaushort{1245, \none 35,\none \none 6}};
\node[ right = 1 and 1 of A] (C) {\ytableaushort{1234, \none 45,\none \none 6}};
\node[below right = 1 and 1 of A] (D) {\ytableaushort{1236, \none 45,\none \none 6}};
\path (A) edge[pilpil,shorten >=-8mm] node[above]{$\rho_3$} (B);
\path (A) edge[pilpil] node[above]{$\rho_4$} (C);
\path (A) edge[pilpil] node[above]{$\rho_5$} (D);
\end{tikzpicture}
...
\begin{figure}[h]
\begin{tikzpicture}
\node (T) {$T= \;$\ytableaushort{12345,\none \none 567, \none \none \none 78{10}, \none \none \none 89{11}{12}{13}}};
\node[right  = 1 of T] (T4) {\ytableaushort{ 12345,\none \none 467, \none \none \none 78{10}, \none \none \none 89{11}{12}{13} }};
\node[right  = 1 of T4] (T5) {\ytableaushort{ 12346,\none \none 457, \none \none \none 78{10}, \none \none \none 89{11}{12}{13} }};
\node[below  = 1.3 of T] (T6) {\ytableaushort{ 12346,\none \none 457, \none \none \none 68{10}, \none \none \none 89{11}{12}{13} }};
\node[right  = 1 of T6] (T7) {\ytableaushort{ 12346,\none \none 457, \none \none \none 68{10}, \none \none \none 79{11}{12}{13} }};
\node[right  = 1 of T7] (T9) {\ytableaushort{ 12346,\none \none 457, \none \none \none 689, \none \none \none 7{10}{11}{12}{13} }\hspace{-4em}$=\pro(T)$};
...
The authors thank Julianna Tymoczko for introducing them to each other.
